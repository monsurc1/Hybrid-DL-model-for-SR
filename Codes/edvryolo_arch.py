...
from FusionModule import AttentionFusionModule, StackFusionModule
...
class EDVRYOLOFT(nn.Module):
    ...
    def __init__(self,
                 ...
                 with_tsa=True):
        super(EDVRYOLOFT, self).__init__()
        ...
        # activation function
        self.lrelu = nn.LeakyReLU(negative_slope=0.1, inplace=True)
        # self.fusion0 = AttentionFusionModule()
        # self.fusion1 = AttentionFusionModule()
        # self.fusion2 = AttentionFusionModule()

        self.fusion0 = StackFusionModule()
        self.fusion1 = StackFusionModule()
        self.fusion2 = StackFusionModule()
    ...
    def forward(self, x):
        ...
        for i in range(t):
            ...
            # Attention Fusion, Can be improved with Stacking
